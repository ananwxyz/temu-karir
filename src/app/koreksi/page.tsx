...
export default function SubmitCorrectionPage() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const name = `[KOREKSI] ${originalName}`;
        const slug = slugify(originalName) + "-koreksi-" + Date.now();
        ...
        try {
            ...
            if (result) {
                ...
                setError("Gagal mengirim data koreksi. Silakan coba lagi.");
            }
        } catch (err) {
            ...
            <div className="min-h-[80vh] flex items-center justify-center px-4">
                <div className="text-center max-w-md">
                    ...
                    <p className="text-muted-foreground mb-6">
                        Data koreksi perusahaan Anda telah dikirim dan sedang menunggu tinjauan admin.
                        Bantuan Anda sangat berarti untuk akurasi direktori ini!
                    </p>
                    ...
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Bantu kami memperbaiki informasi perusahaan yang kurang tepat
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
                <div className="rounded-xl border bg-card p-6 sm:p-8">
                    <p className="text-sm text-muted-foreground mb-6">
                        Isi form di bawah dengan <b>data yang benar/terbaru</b>. Admin akan meninjau dan mengganti data lama dengan data laporan koreksi dari Anda ini.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                <Label htmlFor="name" className="text-xs font-medium">
                                    Nama Perusahaan (Yang Dikoreksi) *
                                </Label>
                                <Input
                                    id="name"
                                    name="name"
                        ...
                        <div className="border-t pt-5">
                            <p className="text-xs font-medium text-muted-foreground mb-3">
                                Kontak & Sosial Media Terbaru (opsional)
                            </p>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-1.5">
